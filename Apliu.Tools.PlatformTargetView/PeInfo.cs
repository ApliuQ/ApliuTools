...
namespace Apliu.Tools.PlatformTargetView
{
    ...
    public class PeInfo
    {
        ...
        {
            PEFileByte = File.ReadAllBytes(FileName); ;
            LoadFile();
        }
        ...
        private void Loadbyte(ref byte[] Data)
        {
            ...
            //var dd = "";
            //for (int i = 0; i < PEFileByte.Length; i++)
            //{
            //    dd += (char)PEFileByte[i];
            //}
            ////File.WriteAllText("F:\\Other\\PEFileByte.txt", dd);
            //File.WriteAllBytes("F:\\Other\\PEFileByte.txt", PEFileByte);


            //var de1e = (char)PEFileByte[128];
            //var de2e = (char)PEFileByte[129];
            //var de3e = (char)PEFileByte[130];
            //var de4e = (char)PEFileByte[131];
            //var de41e = (char)PEFileByte[132];
            //var de42e = (char)PEFileByte[133];
            //var de43e = (char)PEFileByte[134];
            //var de44e = (char)PEFileByte[135];
            //var de45e = (char)PEFileByte[136];
